...
<nav class="menu-mobile-custom">
    ...
    <div class="menu-col">
        <?php if(auth()->guard()->check()): ?>
            <a href="<?php echo e(route('profile.deposit-card')); ?>" class="menu-item">
                <i class="bx bx-wallet"></i>
                <div class="menu-text"><?php echo e(number_format(Auth::user()->balance)); ?> VNĐ</div>
            </a>
        <?php else: ?>
    ...
    <div class="menu-col avatar-center">
        <a href="/" class="menu-avatar-link">
            <div class="menu-avatar">
                <img src="<?php echo e(config_get('site_favicon')); ?>" alt="ICON">
            </div>
        </a>
    </div>
...
<?php /**PATH C:\Users\LEGION\Documents\Sources\shop\resources\views/layouts/user/menu-mobile.blade.php ENDPATH**/ ?>