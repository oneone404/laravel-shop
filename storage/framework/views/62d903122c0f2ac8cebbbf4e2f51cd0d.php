<?php $__env->startSection('title', 'Quản Lý Tài Khoản Random'); ?>
...
<?php if(session('success')): ?>
    <div id="alert-success"
        ...
        <div class="flex items-center gap-2">
            <img src="<?php echo e(asset('assets/img/icons/check.svg')); ?>" class="w-5 h-5" alt="success">
...
<?php if(session('error')): ?>
    <div id="alert-error"
        ...
        <div class="flex items-center gap-2">
            <img src="<?php echo e(asset('assets/img/icons/error.svg')); ?>" class="w-5 h-5" alt="error">
...
<?php endif; ?>
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        ...
        <div class="flex flex-col sm:flex-row gap-3 mt-3 sm:mt-0">
            ...
            <a href="<?php echo e(route('seller.accounts.random.create')); ?>"
    ...
    <div class="bg-white rounded-2xl border border-gray-100 overflow-hidden">
        <div class="p-5 border-b flex items-center justify-between bg-gradient-to-r from-purple-50 to-pink-50">
            <h3 class="font-semibold text-gray-800 flex items-center gap-2">
                <img src="<?php echo e(asset('assets/img/icons/random.svg')); ?>" class="w-5 h-5" alt="icon">
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full text-sm text-left whitespace-nowrap">
                ...
                <tbody class="divide-y divide-gray-100">
                    <?php $__empty_1 = true; $__currentLoopData = $randomGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php
                            $accountsData = $group->accounts_data ?? [];
                            $accountCount = count($accountsData);
                        ?>
                        <tr class="hover:bg-gray-50 transition-all duration-150">
                            <td class="px-5 py-3 text-center text-gray-500 font-medium"><?php echo e($randomGroups->firstItem() + $key); ?></td>
                            <td class="px-5 py-3 text-center">
                                <div class="flex justify-center">
                                    <div class="relative w-20 aspect-video rounded-lg overflow-hidden border border-gray-200 bg-gray-50">
                                        <img src="<?php echo e(asset($group->thumb ?? 'assets/img/placeholder.png')); ?>"
                                             alt="Thumbnail"
                            ...
                            <td class="px-5 py-3 font-semibold text-gray-900">
                                <?php echo e($group->category->name ?? 'N/A'); ?>
                            ...
                            <td class="px-5 py-3 text-center">
                                ...
                                ?>
                                <button onclick="openAccountsModal(<?php echo e($group->id); ?>, '<?php echo e(addslashes($group->category->name ?? 'N/A')); ?>', <?php echo e(json_encode($myAccounts)); ?>)"
                                    ...
                                    <?php echo e(count($myAccounts)); ?> / <?php echo e($accountCount); ?>

                                </button>
                            </td>
                            <td class="px-5 py-3 text-center">
                                <span class="px-3 py-1 bg-blue-100 text-blue-700 text-xs font-semibold rounded-full">
                                    <?php echo e($group->sold_count ?? 0); ?>

                                </span>
                            </td>
                            <td class="px-5 py-3 text-center text-green-700 font-semibold">
                                <?php echo e(number_format($group->price)); ?> <span class="text-xs text-gray-500">VNĐ</span>
                            </td>
                            <td class="px-5 py-3 text-center">
                                <?php if($group->status === 'available' && $accountCount > 0): ?>
                            ...
                            <td class="px-5 py-3 text-center">
                                <div class="flex justify-center gap-2">
                                    <a href="<?php echo e(route('seller.accounts.random.edit', $group->id)); ?>"
                                       class="hover:scale-110 transition" title="Sửa">
                                        <img src="<?php echo e(asset('assets/img/icons/edit.svg')); ?>" class="w-4 h-4" alt="edit">
                                    </a>
                                    <form action="<?php echo e(route('seller.accounts.random.destroy', $group->id)); ?>"
                                          method="POST"
                                        ...
                                        <button type="submit" class="hover:scale-110 transition" title="Xóa">
                                            <img src="<?php echo e(asset('assets/img/icons/delete.svg')); ?>" class="w-4 h-4" alt="delete">
                                        </button>
                                    </form>
                                </div>
                            </td>
        ...
        <div class="p-5 border-t bg-white rounded-b-xl flex flex-col sm:flex-row justify-between items-center gap-3 sm:gap-6">
            <p class="text-xs sm:text-sm text-gray-500">
                Hiển thị
                <span class="font-semibold text-primary"><?php echo e($randomGroups->firstItem()); ?></span> -
                <span class="font-semibold text-primary"><?php echo e($randomGroups->lastItem()); ?></span> /
                Tổng <span class="font-semibold text-secondary"><?php echo e($randomGroups->total()); ?></span> nhóm
            </p>

            <div class="flex items-center space-x-1">
                <?php echo e($randomGroups->links()); ?>
...
<?php echo $__env->make('layouts.seller.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LEGION\Documents\Sources\shop\resources\views/seller/accounts/random/index.blade.php ENDPATH**/ ?>