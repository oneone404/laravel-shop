        ...
        <div class="balance-body">
            <div class="balance-content">
                ...
                <div class="transfer-card">
                    <div class="bank-info">
                        <img src="<?php echo e(asset('images/acbank.png')); ?>" alt="ACB">
                        <strong><?php echo e($bankCode ?? 'ACB'); ?></strong>
                    </div>

                    <div class="info-row">
                        <span>Chủ tài khoản:</span>
                        <strong><?php echo e($accountName ?? 'N/A'); ?></strong>
                    </div>

                    <div class="info-row">
                        <span>Số tài khoản:</span>
                        <div class="copy-box">
                            <strong id="stk"><?php echo e($accountNumber ?? 'N/A'); ?></strong>
                    ...
                    <div class="info-row">
                        <span>Nội dung:</span>
                        <div class="copy-box">
                            <strong id="noidung">ONEDZ<?php echo e(Auth::user()->id); ?></strong>
                ...
                <div class="qr-container">
                    <img id="qrImage"
                        src="https://qr.sepay.vn/img?bank=<?php echo e($bankCode ?? 'ACB'); ?>&acc=<?php echo e($accountNumber ?? ''); ?>&template=&des=ONEDZ<?php echo e(Auth::id()); ?>"
                        alt="QR Code">
    ...
    <div class="balance-modal" id="balanceModal1">
        ...
        <div class="balance-body">
            <div class="balance-content">
                ...
                <a href="<?php echo e(route('login')); ?>" class="btn btn--primary" style="width: 100%;">ĐĂNG NHẬP NGAY</a>
                <button class="modal-close-btn" onclick="closeModal('balanceModal1')">Đóng</button>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\Users\LEGION\Documents\Sources\shop\resources\views/user/partials/deposit-modals.blade.php ENDPATH**/ ?>