...
<?php $component = App\View\Components\HeroHeader::resolve(['title' => 'TÀI KHOẢN #'.e($account->id).'','description' => ''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
        ...
        <div class="detail__content">
            ...
            <div class="detail__actions">
                <?php if($account->status === 'available'): ?>
                    <button class="detail__btn detail__btn--primary" onclick="buyAccount(<?php echo e($account->id); ?>)">
            ...
            <div class="detail__images">
                <h2 class="detail__images-title">HÌNH ẢNH CHI TIẾT <span class="text-danger">#<?php echo e($account->id); ?></span></h2>
                <div class="detail__images-list">
                    <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e($image); ?>" title="Xem Ảnh Lớn" class="detail__images-link">
                            <img src="<?php echo e($image); ?>" class="detail__images-item">
                        </a>
...
<div id="purchaseModal" class="modal">
    <div class="modal__content">
        <div class="modal__header">
            <h2 class="modal__title">MUA TÀI KHOẢN #<?php echo e($account->id); ?></h2>
        ...
        <div class="modal__price-section">
            <div class="modal__price-row">
                ...
                <span class="modal__price-value" id="originalPrice"><?php echo e(number_format($account->price, 0, '.', '.')); ?> VND</span>
            </div>
            ...
            <div class="modal__price-row modal__total-row">
                ...
                <span class="modal__price-value modal__total-value" id="totalPrice"><?php echo e(number_format($account->price, 0, '.', '.')); ?> VND</span>
            </div>
        </div>
...
<script>
let originalPrice = <?php echo e($account->price); ?>;
...
function checkDiscountCode(context) {
    ...
    fetch('<?php echo e(route("discount.validate")); ?>', {
        method: 'POST',
        headers: {
...
function submitPurchase() {
    ...
    fetch('<?php echo e(route("account.purchase", ":id")); ?>'.replace(':id', accountId), {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
...
function submitPlayDirectPayment() {
    ...
    fetch('<?php echo e(route("direct-payment.create-account", ":id")); ?>'.replace(':id', accountId), {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'Accept': 'application/json',
...
<?php echo $__env->make('layouts.user.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LEGION\Documents\Sources\shop\resources\views/user/account/detail.blade.php ENDPATH**/ ?>