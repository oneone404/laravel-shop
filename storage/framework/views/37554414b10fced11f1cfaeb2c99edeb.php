  ...
  <header class="bg-white p-4 flex justify-between items-center sticky top-0 z-30">
    <div class="flex items-center gap-3">
      <button onclick="toggleSidebar()" class="md:hidden text-gray-600 text-2xl relative z-40">
        <img src="<?php echo e(asset('assets/img/icons/list-menu.svg')); ?>" class="w-6 h-6" alt="menu">
      </button>
  ...
  SELLER PANEL
    ...
    <div class="flex items-center gap-3">
      <div class="text-right hidden sm:block">
        <p class="font-semibold text-gray-800"><?php echo e(Auth::user()->username ?? 'Seller'); ?></p>
        <p class="text-sm text-gray-500">Seller</p>
      </div>
      <img src="<?php echo e(config_get('site_favicon')); ?>" class="w-10 h-10 rounded-full border-2 border-primary" alt="avatar">
    </div>
  </header>
  ...
  <div class="flex flex-1 relative">
    ...
    <aside id="sidebar"
      ...
      <div class="sidebar-header-mobile flex items-center justify-between p-4 border-b bg-white sticky top-0 z-10">
        <div class="flex items-center gap-3">
          <img src="<?php echo e(asset('assets/img/icons/list-menu.svg')); ?>" class="w-6 h-6 text-gray-600 opacity-80" alt="menu">
<h2 class="text-lg md:text-2xl font-extrabold text-primary ml-2 md:ml-4 tracking-wide">
  SELLER PANEL
        ...
        <button onclick="closeSidebar()" class="text-gray-600 hover:text-red-500 text-xl">
         <img src="<?php echo e(asset('assets/img/icons/close2.svg')); ?>"
      ...
      <nav class="p-4 space-y-1 overflow-y-auto h-[calc(100vh-64px)]">
        ...
        <a href="<?php echo e(route('seller.dashboard')); ?>"
           class="flex items-center justify-between px-4 py-2 rounded-lg font-medium text-xs transition
                  <?php echo e(request()->routeIs('seller.dashboard')
                      ? 'bg-primary text-white'
                      : 'text-gray-700 hover:bg-primary hover:text-white'); ?>">
            <div class="flex items-center gap-3">
                <img src="<?php echo e(asset('assets/img/icons/dashboard.svg')); ?>"
                     class="w-4 h-4 sm:w-5 sm:h-5" alt="dashboard">
                <span class="tracking-wide">BẢNG ĐIỀU KHIỂN</span>
            </div>
            <img src="<?php echo e(asset('assets/img/icons/chevron-right.svg')); ?>"
        ...
        <a href="<?php echo e(route('seller.categories.index')); ?>"
           class="flex items-center justify-between px-4 py-2 rounded-lg font-medium text-xs transition
                  <?php echo e(request()->routeIs('seller.categories.*')
                      ? 'bg-primary text-white'
                      : 'text-gray-700 hover:bg-primary hover:text-white'); ?>">
            <div class="flex items-center gap-3">
                <img src="<?php echo e(asset('assets/img/icons/product.svg')); ?>"
        ...
        <div class="space-y-1">
            ...
            <a href="<?php echo e(route('seller.accounts.play.index')); ?>"
               class="flex items-center justify-between px-4 py-2 rounded-lg font-medium text-xs transition ml-2
                      <?php echo e(request()->routeIs('seller.accounts.play.*')
                ...
                <img src="<?php echo e(asset('assets/img/icons/chevron-right.svg')); ?>" class="w-3 h-3 opacity-60" alt=">">
            </a>

            
            <a href="<?php echo e(route('seller.accounts.clone.index')); ?>"
               class="flex items-center justify-between px-4 py-2 rounded-lg font-medium text-xs transition ml-2
                      <?php echo e(request()->routeIs('seller.accounts.clone.*')
            ...
            <a href="<?php echo e(route('seller.accounts.random.index')); ?>"
               class="flex items-center justify-between px-4 py-2 rounded-lg font-medium text-xs transition ml-2
                      <?php echo e(request()->routeIs('seller.accounts.random.*')
        ...
        <a href="<?php echo e(route('seller.history.accounts')); ?>"
           class="flex items-center justify-between px-4 py-2 rounded-lg font-medium text-xs transition
                  <?php echo e(request()->routeIs('seller.history.*')
                      ? 'bg-primary text-white'
                      : 'text-gray-700 hover:bg-primary hover:text-white'); ?>">
            <div class="flex items-center gap-3">
                <img src="<?php echo e(asset('assets/img/icons/time.svg')); ?>"
        ...
        <a href="#"
           class="flex items-center justify-between px-4 py-2 rounded-lg font-medium text-xs transition
                  <?php echo e(request()->routeIs('seller.settings.*')
                      ? 'bg-primary text-white'
                      : 'text-gray-700 hover:bg-primary hover:text-white'); ?>">
            <div class="flex items-center gap-3">
                <img src="<?php echo e(asset('assets/img/icons/settings.svg')); ?>"
...
<?php /**PATH C:\Users\LEGION\Documents\Sources\shop\resources\views/layouts/seller/app.blade.php ENDPATH**/ ?>