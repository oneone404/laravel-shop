<?php $__env->startSection('title', 'Xác Nhận Nhận Key'); ?>
    ...
    <div class="confirm-card">
        ...
        <div class="confirm-body">
            <?php if($tooFast ?? false): ?>
                ...
                <a href="<?php echo e(route('hacks.show', 1)); ?>" class="btn-activate" style="text-decoration: none; background: linear-gradient(135deg, #6366f1 0%, #8b5cf6 100%);">
            ...
            <?php else: ?>
                ...
                <form method="POST" action="<?php echo e(route('keyfree.activate', ['token' => $token])); ?>" id="activateForm">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.user.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LEGION\Documents\Sources\shop\resources\views/user/keyfree-confirm.blade.php ENDPATH**/ ?>