            ...
            <div class="pending-row">
                <div class="pending-banner">
                    <div class="pending-banner__info">
                        ...
                        <span>Bạn Đang Có Đơn Hàng <strong>#{{ $order->order_code }}</strong> Chưa Thanh Toán</span>
                    </div>
                    <a href="{{ route('direct-payment.show', $order->order_code) }}" class="pending-banner__btn">
                        THANH TOÁN NGAY
                    </a>
                </div>
            </div>
...
<x-hero-header title="TÀI KHOẢN PLAY 1" description="" />
<section class="menu">
    <div class="container">
...
<x-hero-header title="TÀI KHOẢN PLAY 2" description="" />
<section class="menu">
    <div class="container">
...
<x-hero-header title="TÀI KHOẢN PLAY 3" description="" />
<section class="menu">
    <div class="container">
