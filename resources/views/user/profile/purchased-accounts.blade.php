                                            ...
                                            <tbody>
                                                @forelse($transactions as $transaction)
                                                    <tr>
                                                       ...
                                                       <td class="text-bold">{{ $transaction->account_name }}
    <button class="copy-btn" data-clipboard-text="{{ $transaction->account_name }}">
        <i class="fas fa-copy"></i>
    </button>
</td>
<td class="text-bold">{{ $transaction->password }}
    <button class="copy-btn" data-clipboard-text="{{ $transaction->password }}">
        <i class="fas fa-copy"></i>
    </button>
</td>
