...
<tbody>
    <tr>
        ...
        <td>{{ number_format($transactionSummary['deposit']['yesterday']) }} VNĐ</td>
        <td>{{ number_format($transactionSummary['deposit']['day']) }} VNĐ</td>
        <td>{{ number_format($transactionSummary['deposit']['week']) }} VNĐ</td>
        <td>{{ number_format($transactionSummary['deposit']['month']) }} VNĐ</td>
    </tr>
    <tr>
        <td class="text-start">Mua Hàng</td>
        <td>{{ number_format($transactionSummary['purchase']['yesterday']) }} VNĐ</td>
        <td>{{ number_format($transactionSummary['purchase']['day']) }} VNĐ</td>
        <td>{{ number_format($transactionSummary['purchase']['week']) }} VNĐ</td>
        <td>{{ number_format($transactionSummary['purchase']['month']) }} VNĐ</td>
    </tr>
</tbody>
